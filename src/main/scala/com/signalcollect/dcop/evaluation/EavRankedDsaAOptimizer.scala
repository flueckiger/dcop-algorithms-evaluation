...
class EavRankedDsaAOptimizer[AgentId, Action, Config <: RankedConfig[AgentId, Action, UtilityType, Config] with EavConfig[AgentId, Action, UtilityType, Config], UtilityType](changeProbability: Double)(implicit utilEv: Fractional[UtilityType]) extends Optimizer[AgentId, Action, Config, UtilityType] {
